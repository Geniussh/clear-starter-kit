...
bad_remote_message() {
  ...
  log_error "It should have been automatically set, but given it isn't. Please run \`git remote add aicrowd git@gitlab.aicrowd.com:<username>/data-purchasing-challenge-2022-starter-kit.git\` manually."
  exit 1
}
